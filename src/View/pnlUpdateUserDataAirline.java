 ...
 * @author Booh
 */
public class pnlUpdateUserDataAirline extends javax.swing.JPanel {
    ...
    public pnlUpdateUserDataAirline() {
        initComponents();
    ...
    private void tblUsuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUsuariosMouseClicked
        ...
        clsAirlineStaff FlightRequirementsSearch = controlAdminAirline.readStaffEmail(id);
    ...
    private void btActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btActualizarActionPerformed
        ...
        if(tblUsuarios.getSelectedRow() == -1){
            ...
            if(id.equals("") || nombres.equals("") || apellidos.equals("") || telefono.equals("") || email.equals("") || usuario.equals("")){
                ...
                clsAirlineStaff UserRequirementsSearch = controlAdminAirline.readStaffA(id);
                ...
                if(UserRequirementsSearch != null){
                    ...
                    clsAirlineStaff updateUser = new clsAirlineStaff(0, id, nombres, apellidos, telefono, email, usuario, contrasenia);

                    controlAdminAirline.updateUser(updateUser);
