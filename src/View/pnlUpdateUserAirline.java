...
public class pnlUpdateUserAirline extends javax.swing.JPanel {
        ...
        if(tblUsuario.getSelectedRow() == -1){
            ...
            if(id.equals("") || nombres.equals("") || apellidos.equals("") || telefono.equals("") || email.equals("") || usuario.equals("") || contrasenia.equals("") || contrasenia2.equals("")){
                ...
                if(!contrasenia.equals(contrasenia2)){
                    ...
                    clsAirlineStaff updateUser = new clsAirlineStaff(0, id, nombres, apellidos, telefono, email, usuario, encryptedPassword);
    ...
    private void tblUsuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUsuarioMouseClicked
        ...
        clsAirlineStaff FlightRequirementsSearch = controlAdminAirline.readStaffA(id);
