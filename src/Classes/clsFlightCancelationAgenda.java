 ...
 * @author Booh
 */
public class clsFlightCancelationAgenda {
    ...
    public clsFlightCancelationAgenda(int id, String codigoVueloAgenda, String tipoVuelo, String claseVuelo, String tripulación, String destino, String pista, String fecha, String tiempo, String descripcion, String idAerolinea) {
        this.id = id;
