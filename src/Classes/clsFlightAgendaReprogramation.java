 ...
 * @author Booh
 */
public class clsFlightAgendaReprogramation {
    ...
    public clsFlightAgendaReprogramation(int id, String codigoVueloAgenda, String tipoVuelo, String claseVuelo, String tripulación, String destino, String pista, String fecha, String tiempo, String descripcion, String idAerolinea) {
        this.id = id;
