...
public class Constants {
    ...
    public static final String PANEL_DELETEUSER_AIRPORT = "pnlDeleteUserAirport";
    public static final String PANEL_DELETEUSER_AIRLINE = "pnlDeleteUserAirline";
    ...
    public static final String PANEL_UPDATE_USERS_AIRLINE = "pnlUpdateUserDataAirline";
    ...
    public static final String PANEL_REPORTS_USERS_AIRLINE = "pnlReportsUserAirline";
    ...
    public static final String TITLE_UPDATE_USERS_AIRLINE = "ACTUALIZAR USUARIOS";
    ...
    public static final String TITLE_REPORTS_USERS_AIRLINE = "REPORTE DE USUARIOS";
